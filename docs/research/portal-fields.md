...
Part A（AU 四校，143 行）：2026-08-14 一手抓取所得；原 agent 因会话额度中断未能落盘，为其成果的抢救留存。
Part B（UK 三校）/ Part C（US 三校）/ Part D 跨国复用分析 / Part E 未确认清单：2026-08-15 续做。
字段表见同目录 portal-fields.tsv（303 行字段，11 列，含 AU/UK/US 十所学校）。
