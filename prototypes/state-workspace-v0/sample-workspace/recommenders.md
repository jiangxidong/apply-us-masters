...
|---|---|---|---|---|---|
| r1 | 王教授 | 本科毕设导师 | 素材 m02 的学术表现；毕设全过程 | ❌ **未确认** | 是 |
| r2 | 陈 leader | 现直属主管 | 素材 m01 的三问全过程与结果数字 | ❌ **未确认** | 是 |
| r3 | 李老师 | 交换期间授课教师 | 素材 m02 的课堂表现 | ❌ **未确认** | 否 |
...
🔴 **本块仍与 [#52](https://github.com/jiangxidong/EduApplication/issues/52) 无关**：门槛算得出来，不代表「谁该被分配」定了。
上面那条 `voice` 定义域的待裁决照旧。
